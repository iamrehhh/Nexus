  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.card}>
        ...
        <p className={styles.sub}>Your AI companion. Personal, private, and always here.</p>
        ...
        <p className={styles.note}>Your conversations are private and saved per account.</p>
      </div>
    </div>
  )
}
